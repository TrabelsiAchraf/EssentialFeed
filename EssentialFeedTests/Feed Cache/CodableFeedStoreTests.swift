...
//  EssentialFeedTests
//
//  Created by Achraf Trabelsi on 17/11/2021.
//
        ...
        sut.retrieve { firstResult in
            sut.retrieve { secondResult in
                ...
                case (.empty, .empty):
                    break
                default:
                    XCTFail("Expected retrieving twice from empty cache to deliver same result result, got \(firstResult) and \(secondResult) instead")
                }
